...
RSpec.describe "clinic_histories/edit", type: :view do
  before(:each) do
  ...
  it "renders the edit clinic_history form" do
    render

    assert_select "form[action=?][method=?]", clinic_history_path(@clinic_history), "post" do
